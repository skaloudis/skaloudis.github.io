...
Τοπικό Ελάχιστο στο x=0 με ελάχιστη τιμή το $f(0)=0$ : (0,0).\\
Για $x=0$, $f(0)=0$ επομένως το σημείο τομής με τους άξονες είναι: (0,0).


%$$
%\lim _{x \rightarrow-1^{+}} f(x)=\lim _{x \rightarrow-1^{+}} \frac{x^{2}}{\sqrt{x+1}}=1 \cdot(+\infty)=+\infty 
%$$
%Κατακόρυφη ασύμπτωτη στο $x=-1$ 
